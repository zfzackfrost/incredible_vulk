 ...
 * @brief Boost.Parameter keywords.
 */
...
namespace ivulk {
	BOOST_PARAMETER_NAME(base)
	BOOST_PARAMETER_NAME(color)
	BOOST_PARAMETER_NAME(depth)
	...
	BOOST_PARAMETER_NAME(layout)
	BOOST_PARAMETER_NAME(stageFlags)
	BOOST_PARAMETER_NAME(data)
	BOOST_PARAMETER_NAME(getPriority)
	BOOST_PARAMETER_NAME(vertexBuffer)
	BOOST_PARAMETER_NAME(vertices)
	BOOST_PARAMETER_NAME(xform)
} // namespace ivulk

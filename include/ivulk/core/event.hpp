...
namespace ivulk {
	...
	struct Event
	{
		...
		KeyEvent assumeKeyEvent()
		{
			return std::get<KeyEvent>(data);
		}
		MouseButtonEvent assumeMouseBtnEvent()
		{
			return std::get<MouseButtonEvent>(data);
		}
		MouseMoveEvent assumeMouseMoveEvent()
		{
			return std::get<MouseMoveEvent>(data);
		}
